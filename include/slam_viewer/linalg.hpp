...
template<class T> constexpr Slam_viewer::linalg::mat<T,3,3> Slam_viewer::linalg::adjugate(const mat<T,3,3> & a)
{
...
template<class T> constexpr Slam_viewer::linalg::mat<T,4,4> Slam_viewer::linalg::adjugate(const mat<T,4,4> & a)
{
...
template<class T> constexpr T Slam_viewer::linalg::determinant(const mat<T,4,4> & a)
{
...
template<class T> Slam_viewer::linalg::vec<T,4> Slam_viewer::linalg::rotation_quat(const mat<T,3,3> & m)
{
...
template<class T> Slam_viewer::linalg::mat<T,4,4> Slam_viewer::linalg::frustum_matrix(T x0, T x1, T y0, T y1, T n, T f, fwd_axis a, z_range z)
{
